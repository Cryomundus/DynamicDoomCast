Class ZSDDCChaingunGuyRef : ChaingunGuy
{
	Default {
	+MissileMore;
	+MissileEvenMore;
...
Class ChaingunGuyModStatesinheritor : ZSDDCChaingunGuyRef
{
	Default
	{
	//MDN Stuff;
  ...
  // TNT1 AAA 0 A_SpawnItemEx("BlueCoin", 0, 0,8,-7,Random(-3,3),11,0);
   ...
   Death.Tackle:
	//	TNT1 AAA 0 A_SpawnItemEx("BlueCoin", 0, 0,8,-7,Random(-3,3),11,0);
		TNT1 A 0 A_Scream;
		TNT1 A 0 A_SpawnItemEx("GunBody", 0, 0, 40, -20, 0, 20, 0, 128);
	...
	Pain.Stun:
		"####" H 0 A_Jumpifinventory("GunStun",1,"Death.Mid");
	...
	Death.Picked:
	TNT1 AAA 0 A_SpawnItemEx("BlueCoin", 0, 0,8,-7,Random(-3,3),11,0);
	TNT1 A 0 A_GiveInventory("ThrowGun",1,AAPTR_TARGET);
	TNT1 A 0 ThrustThingZ(0,50,0,0);
	TNT1 A 0 A_Scream;
	TNT1 A 0 A_Noblocking;
	 stop;
	...
	Stunned:
		"####" G 0 bright A_GiveInventory("GunStun",1);
		...
		"####" G 0 bright A_TakeInventory("GunStun",1);
		Goto Super::See;
	...
	Death.Stun2:
	TNT1 A 1 A_Jumpifinventory("GunStun",1,"Death.Picked");
	goto Death.Picked;
