Class ZSDDCLostSoulRef : LostSoul
{
	Default {
	+MissileMore;
	+MissileEvenMore;
...
Class LostSoulModStatesinheritor : LostSoul  
{
	Default
	{
	 PainChance "Stun", 256;
	...
	Death.Picked:
		TNT1 A 0 A_GiveInventory("ThrowSoul",1,AAPTR_TARGET);
	...
	GroundStunner:
		...
		goto See;
	Stunned:
		"####" E 0 bright A_GiveInventory("SoulStun",1);
		...
		"####" E 0 bright A_spawnitemex ("StarSprite",-3,0,60,0,random(-5,5),random(-5,5));
		"####" E 0 bright A_SetSpriteRotation(0);
		"####" E 0 bright A_TakeInventory("SoulStun",1);
		Goto Super::See;
	Death.Stun:
		TNT1 A 1 A_Jumpifinventory("SoulStun",1,"Death.Picked");
		goto Death.Picked;
